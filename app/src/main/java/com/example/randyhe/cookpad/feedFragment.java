...
public class feedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getNumRecipes()
    {
        ...
        String currUser = fbAuth.getCurrentUser().getUid();
